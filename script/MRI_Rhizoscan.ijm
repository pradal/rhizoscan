/**
  ...
  * ChangeLog
  * 28/11/2019 Christophe Pradal :
  *   - remove image rotation : change default(done)
  *   - save intermediate stages in control and result directory
 *
*/
...
var _CONTROL_FOLDER = "tmp";
var _RESULT_FOLDER = "result";
var _ROTATE = false;
...
function analyzeRootsInCurrentImage() {
    ...
    // CPL: Save image (1)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage1");
    ...
    // CPL: Save image (2)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage2");
   ...
   // CPL: Save image (3)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage3");
   ...
   // CPL: Save image (4)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage4");
   ...
   // CPL: Save image (5)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage5");
   ...
   // CPL: Save image (6)
    saveAs("Jpg", dir + _CONTROL_FOLDER + "/" + inputTitle+ "_stage6");
